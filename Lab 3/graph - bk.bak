...
(define Lower_right_corner
  (lambda (rectangle)
    (makePoint (retrieve (Upper_right_corner rectangle) 'point car)
                (retrieve (Lower_left_corner rectangle) 'point cadr))))

;; Upper_left_corner -- select the upper left (or north west) corner
;; of the given 'rectangle
(define Upper_left_corner
  (lambda (rectangle)
    (makePoint (retrieve (Lower_left_corner rectangle) 'point car)
                (retrieve (Upper_right_corner rectangle) 'point cadr))))
